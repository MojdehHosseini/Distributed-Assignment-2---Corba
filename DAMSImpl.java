...
public class DAMSImpl extends DAMSPOA {
    private ORB orb;
   ...
   public DAMSImpl() throws IOException {
...
//        logf.addHandler(fh);
   ...
   public void DBconstruct() {
      ...
      //SHE Database
      innerDB.put("SHEA101122",0);
      innerDB.put("SHEM101122",10);
      innerDB.put("SHEE101122",2);
      DB.put("Surgeon", innerDB);

      innerDB.put("SHEA101122",3);
      innerDB.put("SHEM101122",0);
      innerDB.put("SHEE101122",27);
      DB.put("Dental", innerDB);

      innerDB.put("SHEA101122",4);
      innerDB.put("SHEM101122",9);
      innerDB.put("SHEE101122",2);
      ...
      appo.add("SHEE101122");
      booked.put("SHEP1245",appo);
      booked.put("SHEP1345",appo);
      booked.put("SHEP1545",appo);
      booked.put("SHEP1595",appo);

      //MTL Database
      innerDB.put("MTLA101122",0);
      innerDB.put("MTLM101122",10);
      innerDB.put("MTLE101122",2);
      DB.put("Surgeon", innerDB);

      innerDB.put("MTLA101122",3);
      innerDB.put("MTLM101122",0);
      innerDB.put("MTLE101122",27);
      DB.put("Dental", innerDB);

      innerDB.put("MTLA101122",4);
      innerDB.put("MTLM101122",9);
      innerDB.put("MTLE101122",2);
      DB.put("Physician", innerDB);

      appo.add("MTLE101122");
      booked.put("MTLP1245",appo);
      booked.put("MTLP1345",appo);
      booked.put("MTLP1545",appo);
      booked.put("MTLP1595",appo);
   ...
   public String addAppointment(String adminID, String appointmentID, String appointmentType, int capacity) {
      ...
      if (("A").equals(adminID.substring(3,4))){
         //while (!(((HashMap<String,Integer>)DB.get(appointmentType)).equals(""))) {
            if (((HashMap<String,Integer>)DB.get(appointmentType)).containsKey(appointmentID)) {
         ...
         //  System.out.println("inside");
           synchronized (this) {
               ...
               if (((HashMap<String,Integer>)DB.get(appointmentType)).get(appointmentID) >0) {
                 ...
                 s3 = "the"+appointmentID+"of"+appointmentType + "has removed";
                 //logf.info(s3);
                 result=1; // 1 is item cleared with some quantity
                   } 
                 }
              }
        else{
